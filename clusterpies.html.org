...
<html>
  <head>
    ...
    <!--<link rel="points" type="application/json" href="http://localhost:8000/data/coastal_exposure.geojson">-->
  ...
  <body>
    ...
    <script>
      ...
      var geojson,
        metadata = [],
        geojsonPath = 'http://localhost:8000/data/coastal_exposure.geojson',
    ...
    /*Helper function*/
      ...
      //var coastal_exposure = L.geoJson.ajax("http://localhost:8000/data/coastal_exposure.geojson")
      ...
      // $.getJSON("http://localhost:8000/data/coastal_exposure.geojson", function(data) {
